$(document).ready(function () {
  var baseurl = base_url() + "admins/rolepermissions/show";
  var column = [
    { data: "id" },
    { data: "role_name" },
    {
          ...
          if (response.success) {
            if (response.menu_first) {
              sweetAlertMessageWithConfirmNotShowCancelButton(
                response.messages +
                  ".<br>You don't have access to this page.<br><b>Will be redirected to another page.</b>",
                function () {
  ...
  $(document).on("click", ".view-rolepermissions", function () {
