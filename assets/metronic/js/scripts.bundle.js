	...
	return {
		init: function () {
					...
					"1" !== KTCookie.get("sitemap_modal_displayed")
						...
						: "1" !== KTCookie.get("sitemap_modal_popover_displayed") &&
						  setTimeout(function () {
								...
								KTCookie.set("sitemap_modal_popover_displayed", "1", {
									expires: e,
								}),
									bootstrap.Popover.getInstance(l).show();
						  }, 3e3);
			...
			(e = document.querySelector("#kt_app_layout_builder_form"))) &&
				...
				d &&
					(d.closest(".form-check-image").classList.add("active"),
					(d.checked = !0)));
		},
	};
})();
...
var KTAppSidebar = (function () {
	...
	return {
		init: function () {
			var i;
			(e = document.querySelector("#kt_app_sidebar_secondary_wrapper")),
				(t = document.querySelector("#kt_app_sidebar_secondary_tags_collapse")),
				(n = document.querySelector(
					'[href="#kt_app_sidebar_secondary_tags_collapse"]'
				)),
				e &&
					(i = e.querySelector(".menu-link.active")) &&
					!0 !== KTUtil.isVisibleInContainer(i, e) &&
					e.scroll({
						top: KTUtil.getRelativeTopPosition(i, e),
						behavior: "smooth",
					}),
				t &&
					t.addEventListener("shown.bs.collapse", (t) => {
						!0 !== KTUtil.isVisibleInContainer(n, e) &&
							e.scroll({
								top: KTUtil.getRelativeTopPosition(n, e),
								behavior: "smooth",
							});
					});
		},
